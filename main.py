...
from app.group_assignment import router as group_assignment_router
from app.group_assignment.docs_app import group_assignment_docs_app
...
app.include_router(group_assignment_router, prefix="/api/v1")
...
app.mount("/group-assignment-docs", group_assignment_docs_app)
